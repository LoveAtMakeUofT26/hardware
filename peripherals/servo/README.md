...
ESP32 S3 WROOM servo controller that sweeps a servo 60 degrees and returns to start position. The logic applies to all servos in this project - just change the pin accordingly.
